...
public class Online {
    ...
    abstract class CaseServer{
        ...
        public Online OnlineSolution;
        public CaseServer(List<Requests.Request> requestList, Online onlinesolution){
    ...
    class Case1Server extends CaseServer {
        public Case1Server(List<Requests.Request> requestList, Online online){
    ...
    class Case2Server extends CaseServer{
        ...
        public Case2Server(List<Requests.Request> requestList, Online online){
            super(requestList, online);
        }
    ...
    class Case3Server extends CaseServer{
        ...
        public Case3Server(List<Requests.Request> requestList, Online online){
            super(requestList, online);
        }
